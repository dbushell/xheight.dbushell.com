...
<?php /* REMOVED FOR ARCHIVE
							<div class="social">
	                        	<div class="btn">
	                        		<a href="https://twitter.com/share" class="socialite twitter" data-count="vertical" dat-url="<?php the_permalink(); ?>" data-via="xheightblog"<?php if ($twitter_name) { ?> data-text="xheight &mdash; &ldquo;<?php the_title(); ?>&rdquo; by @<?= $twitter_name; ?>" data-via="<?= strip_tags($twitter_name); ?>"<?php } ?>>Tweet</a>
	                        	</div>
	                        	<div class="btn">
